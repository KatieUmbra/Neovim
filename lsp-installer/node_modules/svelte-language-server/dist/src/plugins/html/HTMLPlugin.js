...
class HTMLPlugin {
    ...
    isInComponentTag(html, document, position) {
        return !!(0, documents_1.getNodeIfIsInComponentStartTag)(html, document.offsetAt(position));
    }
    ...
    prepareRename(document, position) {
        ...
        return (0, utils_1.toRange)(document.getText(), tagNameStart, tagNameStart + node.tag.length);
    }
